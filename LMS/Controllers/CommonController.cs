    ...
    public class CommonController : Controller
    {
        ...
        public IActionResult GetCatalog()
        {
            var query = from d in db.Departments
                        select new
                        {
                            subject = d.Subject,
                            dname = d.Name,
                            courses = (from cou in db.Courses
                                       where d.Subject == cou.Department
                                       select new
                                       {
                                           number = cou.Num,
                                           cname = cou.Name
        ...
        public IActionResult GetClassOfferings(string subject, int number)
        {
            var query = from c in db.Classes
                        ...
                        where cou.Department == subject && cou.Num == number
                        select new
                        {
                            season = c.Season,
                            year = c.Year,
        ...
        public IActionResult GetAssignmentContents(string subject, int num, string season, int year, string category, string asgname)
        {
            var query = from a in db.Assignments
                        ...
                        join cou in db.Courses
                        on cl.CourseId equals cou.CourseId
                        where cou.Department == subject && cou.Num == num
        ...
        public IActionResult GetSubmissionText(string subject, int num, string season, int year, string category, string asgname, string uid)
        {
            var query = from a in db.Assignments
                        ...
                        on a.AssignId equals sub.AssignId
                        where cou.Department == subject && cou.Num == num
                        && cl.Season == season && cl.Year == year
                        && ac.Name == category && a.Name == asgname
                        && sub.StudentId == uid
        ...
        public IActionResult GetUser(string uid)
        {
            ...
            if (studQuery != null) { return Json(studQuery); }
            ...
            if (profQuery != null) { return Json(profQuery); }
            ...
            if (adminQuery != null) { return Json(adminQuery); }
